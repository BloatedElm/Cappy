...
Imports System.Web.Security 'imports from database, can it be object oriented though?
Partial Class Login
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not Me.IsPostBack Then
            If Me.Page.User.Identity.IsAuthenticated Then
                ...
                Response.Redirect("~/Login.aspx") 'Redirects if user is not authorzied for view
            Else
                Session.Abandon()
                Session.Clear()
            End If
